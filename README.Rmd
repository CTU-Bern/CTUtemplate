...
The `use_ssreport_template` and `use_report_template` are used to open a new template
...
In contrast to a normal Rmd, here you have to generate a CLO file which is needed
by the UNIBE Latex template. The second chunk in each template shows how to do this. 
