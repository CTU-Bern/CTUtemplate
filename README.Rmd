...
asr(dataframe,
    ...
    n_centers_t = 10, # total number of sites
    n_centers_p = 15, # number of planned sites
    n_centers_c = 0,  # number of closed sites
    n_centers_o = 10, # number of open sites
    n_pat_t = 1000,   # total number of participants
    n_pat_e = 800,    # enrolled participants
    n_pat_c = 100,    # complete participants
    n_pat_p = 2,      # prematurely terminated participants
